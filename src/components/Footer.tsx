const Footer = () => {
  ...
  return (
    <footer className="py-10 px-6 border-t border-border/50 bg-background">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-muted-foreground text-sm text-center md:text-right">
            Built with{" "}
            <span className="text-primary font-medium">Svelte</span>,{" "}
            <span className="text-primary font-medium">React.js</span>,{" "}
            <span className="text-primary font-medium">TypeScript</span>,{" "}
            <span className="text-primary font-medium">Tailwind CSS</span> &{" "}
            <span className="text-primary font-medium">modern frontend architecture</span>
          </p>
